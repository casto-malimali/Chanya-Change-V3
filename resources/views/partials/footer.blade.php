<section class="footer-con position-relative" id="footer">
                ...
                <div class="col-xl-3 col-lg-2 col-md-4 col-sm-4 col-6">
                    <div class="links">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li><i class="fa-solid fa-arrow-right"></i><a href="./activities" class=" text-size-14 text text-decoration-none">Activities</a></li>
                            <li><i class="fa-solid fa-arrow-right"></i><a href="./Events" class=" text-size-14 text text-decoration-none">Events</a></li>
                            <li><i class="fa-solid fa-arrow-right"></i><a href="./chanyaplus" class=" text-size-14 text text-decoration-none">Chanya Plus</a></li>
                    ...
                    <div class="icon">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="text">
                                ...
                                <a href="tel:255759334659" class="text-decoration-none">+255 759 334 659</a>
                            </li>
                            <li class="text">
                                <i class="fa-solid fa-envelope"></i>
                                <a href="mailto:info@chanyachange.org"
                                    class="text-decoration-none">Info@chanyachange.org</a>
                            </li>
                            <li class="text">
    ...
    <div class="copyright">
        <p class="mb-0">Copyright © Chanyachange.org, All Rights Reserved 2024</p>
    </div>
</section>
