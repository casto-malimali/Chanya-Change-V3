@php
    $title = 'Publications';
    $para = 'Chanya change uses different publications in reaching out. Currently we have managed to publish an inspiration book titled “Timiza ndoto na malengo yako” aimed at preparing students expecting to join higher learning institutions.';
@endphp
